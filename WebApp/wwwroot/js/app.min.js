var app = {
    ...
    ajax: {
        ...
        loader: { id: "#app-content-loader", html: '<div id="app-content-loader"><span class="spinner"></span></div>', class: "app-content-loading" },
    ...
    topMenu: {
        ...
        menu: { class: "menu", itemClass: "menu-item", linkClass: "menu-link", activeClass: "active", hasSubClass: "has-sub", expandClass: "expand", submenu: { class: "menu-submenu" } },
        control: {
            class: "menu-control",
    ...
    themePanel: {
        ...
        theme: { toggleAttr: 'data-toggle="theme-selector"', cookieName: "app-theme", id: "#themeCss", activeClass: "active" },
    ...
    animation: { attr: "data-animation", valueAttr: "data-value", speed: 1e3, effect: "swing" },
            ...
            0 === $("." + app.sidebar.minify.toggledClass).length &&
                (e ||
                    ($(t)
                        ...
                        $(t).slideUp(a, function () {
                            $(t)
                                ...
                                .removeClass(app.sidebar.menu.expandClass + " " + app.sidebar.menu.closingClass);
                        })),
                    $(s).is(":visible")
                        ? $(s)
                            .closest("." + app.sidebar.menu.itemClass)
                    ...
                    $(s).slideToggle(a, function () {
                        ...
                        $(s).is(":visible") ? ($(a).addClass(app.sidebar.menu.expandClass), $(a).removeClass(app.sidebar.menu.closedClass)) : ($(a).addClass(app.sidebar.menu.closedClass), $(a).removeClass(app.sidebar.menu.expandClass)),
                            $(a).removeClass(app.sidebar.menu.expandingClass + " " + app.sidebar.menu.closingClass);
                    }));
        }),
            $(document).on(
                "click",
                    ...
                    if (0 === $("." + app.sidebar.minify.toggledClass).length) {
                        ...
                        $(e).is(":visible")
                            ...
                            $(e).slideToggle(a, function () {
                                var a = $(this).closest("." + app.sidebar.menu.itemClass);
                                $(e).is(":visible")
                                    ? ($(a).addClass(app.sidebar.menu.expandClass), $(a).removeClass(app.sidebar.menu.closedClass))
                                    : ($(a).addClass(app.sidebar.menu.closedClass), $(a).removeClass(app.sidebar.menu.expandClass)),
                                    $(a).removeClass(app.sidebar.menu.expandingClass + " " + app.sidebar.menu.closingClass);
                            });
                    }
                }
    ...
    handleSidebarEndToggle = function () {
        ...
        $(document).on("click", "[" + app.sidebarEnd.toggleAttr + "]", function (a) {
            a.preventDefault(),
                $(app.id).hasClass(app.sidebarEnd.toggledClass) || $(app.id).hasClass(app.sidebarEnd.collapsedClass)
    ...
    handlePanelAction = function () {
        ...
        $(document).on("mouseover", "[" + app.panel.toggle.remove.attr + "]", function (a) {
            $(this).attr("data-tooltip-init") || (new bootstrap.Tooltip(this, { title: app.panel.toggle.remove.tooltipText, placement: "bottom" }).show(), $(this).attr("data-tooltip-init", !0));
        }),
            ...
            $(document).on("mouseover", "[" + app.panel.toggle.collapse.attr + "]", function (e) {
                $(this).attr("data-tooltip-init") || ((a = new bootstrap.Tooltip(this, { title: app.panel.toggle.collapse.tooltipText, placement: "bottom" })).show(), $(this).attr("data-tooltip-init", !0));
            }),
            ...
            $(document).on("mouseover", "[" + app.panel.toggle.reload.attr + "]", function (e) {
                $(this).attr("data-tooltip-init") || ((a = new bootstrap.Tooltip(this, { title: app.panel.toggle.reload.tooltipText, placement: "bottom" })).show(), $(this).attr("data-tooltip-init", !0));
            }),
            ...
            $(document).on("mouseover", "[" + app.panel.toggle.expand.attr + "]", function (e) {
                $(this).attr("data-tooltip-init") || ((a = new bootstrap.Tooltip(this, { title: app.panel.toggle.expand.tooltipText, placement: "bottom" })).show(), $(this).attr("data-tooltip-init", !0));
            }),
            $(document).on("click", "[" + app.panel.toggle.expand.attr + "]", function (e) {
                ...
                $("body").hasClass(app.panel.expandClass) && $(s).hasClass(app.panel.expandClass)
                    ? ($("body, ." + app.panel.class).removeClass(app.panel.expandClass), $("." + app.panel.class).removeAttr("style"), $(t).removeAttr("style"))
    ...
    handelTooltipPopoverActivation = function () {
        ...
        if (0 !== $("[" + app.bootstrap.tooltip.attr + "]").length)
            [].slice.call(document.querySelectorAll("[" + app.bootstrap.tooltip.attr + "]")).map(function (a) {
                return new bootstrap.Tooltip(a);
            });
        if (0 !== $("[" + app.bootstrap.popover.attr + "]").length)
            [].slice.call(document.querySelectorAll("[" + app.bootstrap.popover.attr + "]")).map(function (a) {
    ...
    handleScrollToTopButton = function () {
        ...
        $(document).scroll(function () {
            $(document).scrollTop() >= app.scrollToTopBtn.heightShow
                ? $("[" + app.scrollToTopBtn.toggleAttr + "]").hasClass(app.scrollToTopBtn.showClass) || $("[" + app.scrollToTopBtn.toggleAttr + "]").addClass(app.scrollToTopBtn.showClass)
                : $("[" + app.scrollToTopBtn.toggleAttr + "]").removeClass(app.scrollToTopBtn.showClass);
        }),
            $("[" + app.scrollToTopBtn.toggleAttr + "]").click(function (a) {
                a.preventDefault(), $("html, body").animate({ scrollTop: $("body").offset().top }, app.scrollToTopBtn.scrollSpeed);
            });
    },
    handleThemePanel = function () {
        ...
        $(document).on("click", "." + app.themePanel.class + " [" + app.themePanel.theme.toggleAttr + "]", function () {
            ...
            0 === $(app.themePanel.theme.id).length ? $("head").append('<link href="' + a + '" rel="stylesheet" id="' + app.themePanel.theme.id.replace("#", "") + '" />') : $(app.themePanel.theme.id).attr("href", a),
                ...
                Cookies && Cookies.set(app.themePanel.theme.cookieName, e);
        }),
            $(document).on("change", "." + app.themePanel.class + " [" + app.themePanel.themeHeader.toggleAttr + "]", function () {
                var a = "";
                $(this).is(":checked") ? ($("." + app.header.class).addClass(app.themePanel.themeHeader.class), (a = app.themePanel.themeHeader.class)) : $("." + app.header.class).removeClass(app.themePanel.themeHeader.class),
            ...
            $(document).on("change", "." + app.themePanel.class + " [" + app.themePanel.themeHeaderFixed.toggleAttr + "]", function () {
                var a = "";
                $(this).is(":checked")
                    ? ($(app.id).addClass(app.themePanel.themeHeaderFixed.class), (a = app.themePanel.themeHeaderFixed.class))
                    : ($(app.themePanel.themeSidebarFixed.toggleAttr).is(":checked") &&
                        !app.isMobile &&
                        (alert(app.themePanel.themeHeaderFixed.errorMessage), $(app.themePanel.themeSidebarFixed.toggleAttr).prop("checked", !1), $(app.themePanel.themeSidebarFixed.toggleAttr).trigger("change")),
                        $(app.id).removeClass(app.themePanel.themeHeaderFixed.class),
                        (a = app.themePanel.themeHeaderFixed.disabledClass)),
                    Cookies && Cookies.set(app.themePanel.themeHeaderFixed.cookieName, a);
            }),
            $(document).on("change", "." + app.themePanel.class + " [" + app.themePanel.themeSidebarGrid.toggleAttr + "]", function () {
                var a = "";
                $(this).is(":checked") ? ($(app.sidebar.id).addClass(app.themePanel.themeSidebarGrid.class), (a = app.themePanel.themeSidebarGrid.class)) : $(app.sidebar.id).removeClass(app.themePanel.themeSidebarGrid.class),
                    Cookies && Cookies.set(app.themePanel.themeSidebarGrid.cookieName, a);
            }),
            $(document).on("change", "." + app.themePanel.class + " [" + app.themePanel.themeSidebarFixed.toggleAttr + "]", function () {
                ...
                app.isMobile
                    ? ($(this).prop("checked", !0), alert(app.themePanel.themeSidebarFixed.mobileErrorMessage))
                    : ($(this).is(":checked")
                        ? ($("." + app.themePanel.class + " [" + app.themePanel.themeHeaderFixed.toggleAttr + "]").is(":checked") ||
                        ...
                        Cookies && Cookies.set(app.themePanel.themeSidebarFixed.cookieName, a));
            }),
            $(document).on("change", "." + app.themePanel.class + " [" + app.themePanel.themeGradientEnabled.toggleAttr + "]", function () {
                var a = "";
                $(this).is(":checked") ? ($(app.id).addClass(app.themePanel.themeGradientEnabled.class), (a = app.themePanel.themeGradientEnabled.class)) : $(app.id).removeClass(app.themePanel.themeGradientEnabled.class),
                    Cookies && Cookies.set(app.themePanel.themeGradientEnabled.cookieName, a);
            }),
            Cookies &&
            (Cookies.get(app.themePanel.theme.cookieName) && $("." + app.themePanel.class + " [" + app.themePanel.theme.toggleAttr + '][data-theme="' + Cookies.get(app.themePanel.theme.cookieName) + '"]').trigger("click"),
                Cookies.get(app.themePanel.themeHeader.cookieName) &&
                $("." + app.themePanel.class + " [" + app.themePanel.themeHeader.toggleAttr + "]")
                    .prop("checked", !0)
                    .trigger("change"),
                Cookies.get(app.themePanel.themeSidebarGrid.cookieName) &&
                $("." + app.themePanel.class + " [" + app.themePanel.themeSidebarGrid.toggleAttr + "]")
                    .prop("checked", !0)
                    .trigger("change"),
                Cookies.get(app.themePanel.themeGradientEnabled.cookieName) &&
                $("." + app.themePanel.class + " [" + app.themePanel.themeGradientEnabled.toggleAttr + "]")
                    .prop("checked", !0)
                    .trigger("change"),
                Cookies.get(app.themePanel.themeSidebarFixed.cookieName) &&
                Cookies.get(app.themePanel.themeSidebarFixed.cookieName) == app.themePanel.themeSidebarFixed.disabledClass &&
                $("." + app.themePanel.class + " [" + app.themePanel.themeSidebarFixed.toggleAttr + "]")
                    .prop("checked", !1)
                    .trigger("change"),
                Cookies.get(app.themePanel.themeHeaderFixed.cookieName) &&
                Cookies.get(app.themePanel.themeHeaderFixed.cookieName) == app.themePanel.themeHeaderFixed.disabledClass &&
                $("." + app.themePanel.class + " [" + app.themePanel.themeHeaderFixed.toggleAttr + "]")
                    .prop("checked", !1)
                    .trigger("change"));
    },
                ...
                case "next":
                    (n = i + p - l) <= l
                        ...
                        ("rtl" != $("body").css("direction")
                            ? $(s)
                                .find("." + app.bootstrap.nav.tabs.class)
                                .animate({ marginLeft: "-" + o + "px" }, 150, function () {
                                    $(s).addClass(app.unlimitedTabs.overflowLeft.class);
                                })
                            : $(s)
                                .find("." + app.bootstrap.nav.tabs.class)
                                .animate({ marginRight: "-" + o + "px" }, 150, function () {
                                    $(s).addClass(app.unlimitedTabs.overflowLeft.class);
                                }));
                    break;
                case "prev":
                    var n;
                    (n = -p) <= l ? ($(s).removeClass(app.unlimitedTabs.overflowLeft.class), (o = 0)) : (o = n - l + 80),
                        "rtl" != $("body").css("direction")
                            ? $(s)
                                .find("." + app.bootstrap.nav.tabs.class)
                                .animate({ marginLeft: "-" + o + "px" }, 150, function () {
            ...
            $("." + app.unlimitedTabs.class).each(function () {
                !(function (a, e) {
                    ...
                    $(a)
                        ...
                        .first() &&
                        (s = $(a)
                            .find("." + app.bootstrap.nav.tabs.itemClass + " ." + app.bootstrap.nav.tabs.activeClass)
                    ...
                    if (
                        ...
                        o != l && (n += 40),
                            "rtl" == $("body").css("direction")
                                ? $(a)
                                    .find("." + app.bootstrap.nav.tabs.class)
                                    .animate({ marginRight: "-" + n + "px" }, i)
                                : $(a)
                                    .find("." + app.bootstrap.nav.tabs.class)
                                    .animate({ marginLeft: "-" + n + "px" }, i);
                    }
                    l != o && o >= p ? $(a).addClass(app.unlimitedTabs.overflowRight.class) : $(a).removeClass(app.unlimitedTabs.overflowRight.class),
                        l >= p && o >= p ? $(a).addClass(app.unlimitedTabs.overflowLeft.class) : $(a).removeClass(app.unlimitedTabs.overflowLeft.class);
                })(this, 0);
            });
        }
    ...
    handleUnlimitedTopMenuRender = function () {
                ...
                case "next":
                    (n = i + p - l) <= l
                        ? ((o = n - p + 128),
                            setTimeout(function () {
                                $(s)
                                    .find("." + app.topMenu.control.class + "." + app.topMenu.control.buttonNext.class)
                                    .removeClass("show");
                            }, 150))
                        : (o = l - p - 128),
                        0 !== o &&
                        ("rtl" != $("body").css("direction")
                            ? $(s).animate({ marginLeft: "-" + o + "px" }, 150, function () {
                                $(s)
                                    .find("." + app.topMenu.control.class + "." + app.topMenu.control.buttonPrev.class)
                                    .addClass("show");
                            })
                            : $(s).animate({ marginRight: "-" + o + "px" }, 150, function () {
                                $(s)
                                    .find("." + app.topMenu.control.class + "." + app.topMenu.control.buttonPrev.class)
                                    .addClass("show");
                            }));
        ...
        function e() {
            ...
            if (
                ...
                var n = i - l + 128;
                "rtl" != $("body").css("direction") ? $(a).animate({ marginLeft: "-" + n + "px" }, 0) : $(a).animate({ marginRight: "-" + n + "px" }, 0);
            }
            i != o && o >= l
                ? $(a)
                    .find("." + app.topMenu.control.class + "." + app.topMenu.control.buttonNext.class)
            ...
            if ($(window).width() <= 767) {
                var a = $(this)
                    ...
                    e = $(this)
                        ...
                        .find("." + app.topMenu.menu.hasSubClass + " ." + app.topMenu.menu.submenu.class)
                        .not(a);
                $(e)
                    .not(a)
                    .slideUp(250, function () {
    ...
    handleToggleNavProfile = function () {
        ...
        $(document).on("click", "[" + app.sidebar.profile.toggleAttr + "]", function (e) {
            ...
            $(t).is(":visible") ? ($(s).removeClass(app.sidebar.menu.activeClass), $(t).removeClass(app.sidebar.menu.closingClass)) : ($(s).addClass(app.sidebar.menu.activeClass), $(t).addClass(app.sidebar.menu.expandingClass)),
                $(t).slideToggle(a, function () {
                    $(t).is(":visible") ? ($(t).addClass(app.sidebar.menu.expandClass), $(t).removeClass(app.sidebar.menu.closedClass)) : ($(t).addClass(app.sidebar.menu.closedClass), $(t).removeClass(app.sidebar.menu.expandClass)),
                        $(t).removeClass(app.sidebar.menu.expandingClass + " " + app.sidebar.menu.closingClass);
                });
        });
    },
    ...
    handleSidebarMinifyFloatMenu = function () {
        $(document).on("click", app.sidebar.floatSubmenu.id + " ." + app.sidebar.menu.itemClass + "." + app.sidebar.menu.hasSubClass + " > ." + app.sidebar.menu.itemLinkClass, function (a) {
            var e = $(this).next("." + app.sidebar.menu.submenu.class),
                ...
                t = !1,
                p = !1;
            $(e).is(":visible") ? ($(s).addClass("closing"), (t = !0)) : ($(s).addClass("expanding"), (p = !0)),
                $(e).slideToggle({
                    ...
                    progress: function () {
                        ...
                        if (
                            (t &&
                                o > l &&
                                ((o = o > l ? l : o),
                                    $(app.sidebar.floatSubmenu.id).css({ top: o + "px", bottom: "auto" }),
                            ...
                            $(app.sidebar.floatSubmenu.id).css({ top: "auto", bottom: 0 }),
                                $(app.sidebar.floatSubmenu.arrow.id).css({ top: "auto", bottom: d + "px" }),
                                $(app.sidebar.floatSubmenu.line.id).css({ top: "20px", bottom: d + "px" });
                        }
                    },
                    complete: function () {
                        ...
                        if ($(app.id).hasClass(app.sidebar.minify.toggledClass)) {
                            ...
                            if (e) {
                                ...
                                if (0 === $(app.sidebar.floatSubmenu.id).length) {
                                    var r = "";
                                    l > d && (r = app.sidebar.floatSubmenu.overflow.class),
                                        (e =
                                            '<div class="' +
                                    ...
                                    l > d
                                        ...
                                        $(app.sidebar.floatSubmenu.id).attr("data-offset-top", i),
                                        $(app.sidebar.floatSubmenu.id).attr("data-menu-offset-top", i),
                                        $(app.sidebar.floatSubmenu.id + " ." + app.sidebar.floatSubmenu.class).html(e);
                                if (d - i > (l = $(app.sidebar.floatSubmenu.id).height()))
                                    $(app.sidebar.floatSubmenu.id).css({ top: i, left: o, bottom: "auto", right: n }),
                                        $(app.sidebar.floatSubmenu.arrow.id).css({ top: "20px", bottom: "auto" }),
                                        $(app.sidebar.floatSubmenu.line.id).css({ top: "20px", bottom: "auto" });
                                else {
                                    $(app.sidebar.floatSubmenu.id).css({ bottom: 0, top: "auto", left: o, right: n });
                                    var c = d - i - 21;
    ...
    handleAjaxMode = function (a) {
        ...
        function p(s, p, l) {
            ...
            p && ((d = $(p).attr("data-type") ? $(p).attr("data-type") : d), (targetDataDataType = $(p).attr("data-data-type") ? $(p).attr("data-data-type") : d)),
                $.ajax({
                    url: o,
                    type: n,
                    dataType: d,
                    ...
                    t(!0), $("html, body").animate({ scrollTop: 0 }, 0), App.initComponent();
                });
        }
        "" === (s = window.location.hash ? window.location.hash : s) ? $(app.content.id).html(e) : p(s, "", !0),
    ...
    handleSetPageOption = function (a) {
        a.appContentFullHeight && $(app.id).addClass(app.content.fullHeight.class),
            ...
            a.appSidebarMinified && $(app.id).addClass(app.layout.sidebarMinified.class),
            a.appSidebarTwo &&
            ...
            a.appSidebarTransparent && $(app.sidebar.id).addClass(app.sidebar.transparent.class),
            a.appSidebarSearch && $(app.sidebar.id + " ." + app.sidebar.search.class).removeClass(app.sidebar.search.hideClass),
            a.appTopMenu && ($(app.header.id + " [" + app.topMenu.mobile.toggleAttr + "]").removeClass(app.helper.display.none), $(app.id).addClass(app.layout.topMenu.class)),
            a.appWithoutHeader && ($(app.id).addClass(app.layout.withoutHeader.class), $(app.header.id).css("display", "none")),
            a.appWithoutSidebar &&
            ...
            a.pageContentFullWidth && $(app.content.id).addClass(app.content.fullWidth.class),
    ...
    handleClearPageOption = function (a) {
        a.appContentFullHeight && $(app.id).removeClass(app.content.fullHeight.class),
            ...
            a.appSidebarMinified && $(app.id).removeClass(app.layout.sidebarMinified.class),
            a.appSidebarTwo &&
            ...
            a.appSidebarTransparent && $(app.sidebar.id).removeClass(app.sidebar.transparent.class),
            a.appSidebarSearch && $(app.sidebar.id + " ." + app.sidebar.search.class).addClass(app.sidebar.search.hideClass),
            a.appTopMenu && ($(app.header.id + " [" + app.topMenu.mobile.toggleAttr + "]").addClass(app.helper.display.none), $(app.id).removeClass(app.layout.topMenu.class)),
            a.appHeaderInverse && $(app.header.id).removeClass(app.header.inverse.class),
            a.appWithoutSidebar &&
            ...
            a.appWithoutHeader && ($(app.id).removeClass(app.layout.withoutHeader.class), $(app.header.id).removeAttr("style")),
            a.appContentFullWidth && $(app.content.id).removeClass(app.content.fullWidth.class),
                    ...
                    $(
                        ...
                        (e = e.toLowerCase()).search(a) > -1 &&
                            ($(this)
                                ...
                                0 != $(this).closest("." + app.sidebar.menu.itemClass + "." + app.sidebar.menu.hasSubClass).length &&
                                $(this)
                                    .closest("." + app.sidebar.menu.itemClass + "." + app.sidebar.menu.hasSubClass)
                                    .find("." + app.sidebar.menu.submenu.class + " ." + app.sidebar.menu.itemClass + "." + app.sidebar.search.hideClass)
                                    .removeClass(app.sidebar.search.hideClass),
                                0 != $(this).closest("." + app.sidebar.menu.submenu.class).length &&
                                ($(this)
                                    ...
                                    $(this)
                                        .closest("." + app.sidebar.menu.submenu.class)
                                        .find("." + app.sidebar.menu.itemClass + ":not(." + app.sidebar.search.foundClass + ")")
                                        .addClass(app.sidebar.search.hideClass)));
                    }))
                : ($(
                    "." +

...
go
if not exists(select 1 from sys.objects where name like 'q_zu_CustomerPortal_prl')
begin
	exec('create proc q_zu_CustomerPortal_prl as select 123')
end
go
ALTER proc [dbo].[q_zu_CustomerPortal_prl]
(
